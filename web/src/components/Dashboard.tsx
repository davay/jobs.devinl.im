  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="flex-grow">
        ...
        <p className="text-left text-sm pl-1 pb-2">All jobs here are pulled direct from company sites (only) within the last 12 hours. Clicking on a card will bring you to the page where the job was found, not to the job itself.</p>
